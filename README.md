# PHY421: Statistical Mechanics (2026 Spring)

Professor: Prof Manas Khan

## First Half

### Syllabus

| Topic                                          | Pages (1.pdf) | Pages (2.pdf)      | Kardar       | Pathria              | Sethna                |
|------------------------------------------------|---------------|--------------------|--------------|----------------------|-----------------------|
| Probability, Moments & Correlations            | 1–4           | 1–4                | -            | -                    | 1.2                   |
| Continuous Distributions (Uniform, Gaussian, etc.) | 4–7       | 5–8                | -            | -                    | 1.2                   |
| Phase Space & Liouville's Theorem              | 15–17         | 14–17              | 4.1          | 2.1, 2.2             | 4.1, 4.2              |
| Microcanonical Ensemble & Entropy              | 18–21         | 15–18              | 4.2          | 2.3                  | 3.1, 5.1              |
| Ideal Gas (Microcanonical)                     | 22–24         | 19–21, 27–28       | 4.4          | 1.4                  | 3.2                   |
| Gibbs Paradox & Indistinguishability           | -             | 28–30              | 4.5          | 1.5                  | 5.2.1                 |
| Two-State Systems & Negative Temp              | 25–27         | 22–27              | 4.3          | 3.10                 | Exercises 3.1, 6.3    |
| Canonical Ensemble, Z, and F                   | -             | 31–33              | 4.6, 4.7, 4.8| 3.1, 3.2, 3.3        | 6.1, 6.2              |
| Grand Canonical Ensemble & μ                   | -             | 34–35              | 4.9          | 4.1, 4.2, 4.3        | 6.3                   |
| Random Walks & Drunkard's Walk                 | -             | 35–37              | -            | -                    | 2.1                   |
| Diffusion Equation & Advection                 | -             | 37–40              | -            | -                    | 2.2, 2.3, 2.4         |
| Brownian Motion, Drag & Equipartition          | -             | 41–43              | -            | 3.7                  | 6.5                   |
...
**Phase 1: Master the Math and Dynamics with Sethna**
* Sethna is phenomenal for stochastic processes, which clearly make up a huge chunk of your recent lectures.
* Read **Sethna Chapter 1 and Chapter 2**. This will teach you everything about probability distributions, random walks, and deriving the diffusion equation. Read **Sethna Section 6.5** to cover friction, fluctuations, and Brownian motion.

**Phase 2: Conquer the Core Ensembles with Pathria**
* Professor is teaching the classic derivations for Phase space, the Microcanonical ensemble, and the Gibbs Paradox. Pathria explains these with unmatched clarity and rigorous step-by-step math.
* Read **Pathria Chapter 1 and Chapter 2** to understand Phase Space, Liouville's theorem, and how to fix the Gibbs paradox. Then read **Pathria Chapters 3 and 4** to master the Canonical and Grand Canonical ensembles.
